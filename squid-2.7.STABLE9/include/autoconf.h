...
#define CONFIG_HOST_TYPE "mipsel-unknown-linux-gnu"
...
#define SQUID_CONFIGURE_OPTIONS " '--host=mipsel-linux' '--build=i686-ubuntu-linux' '--cache-file=mips-cache' '--disable-epoll' 'build_alias=i686-ubuntu-linux' 'host_alias=mipsel-linux'"
